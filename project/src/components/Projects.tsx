...
const projects = [
  {
    ...
    tags: ['React', 'Web3', 'Smart Contracts', 'Blockchain'],
    color: 'sky',
  ...
  },
  {
    ...
    tags: ['React', 'Tron', 'Wallet', 'Trading', 'Web3'],
    color: 'cyan',
  ...
  },
  {
    ...
    tags: ['React', 'AI', 'DeFi', 'Solana', 'Automation'],
    color: 'teal',
...
export default function Projects() {
  ...
  return (
    <section id="projects" ref={ref as React.RefObject<HTMLElement>} className="py-24 px-6 relative">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-sky-950/8 to-transparent pointer-events-none" />
      <div className="max-w-6xl mx-auto">
        <SectionHeader title="Projects" sub="Things I've built" inView={inView} />
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className={`w-12 h-12 rounded-xl ${p.iconBg} border ${p.border} flex items-center justify-center`}>
                ...
                <div className="flex flex-wrap gap-2">
                  {p.tags.map((t) => (
                    <span key={t} className={`px-2.5 py-0.5 rounded-md border text-xs font-mono ${tagTextMap[p.color]}`}>
                      {t}
                    </span>
                  ))}
                </div>
